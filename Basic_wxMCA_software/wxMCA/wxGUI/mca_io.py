...
class MCA_IO():
    ...
    def __init__(self, using_GUI=True):
        ...
        for identity in self.identities:
            ...
            self.mca[sn].update(has_arm = self.mca[sn]["mca_id"] in [0x100, 0x200, 0x101, 0x201, 0x102, 0x202, 0x103, 0x203, 0x104, 0x204])
            ...
            if self.mca[sn]["mca_id"] in [0x102, 0x202]:
                self.mca[sn]["adc_sr"] = 24.0e6
