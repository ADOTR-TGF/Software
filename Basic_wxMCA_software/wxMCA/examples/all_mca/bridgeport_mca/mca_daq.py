...
class MCA_DAQ():
    def __init__(self, MCA_IO=None, cmd_root="", ctrl_root="", mds_ip=""):
        """
        ...
        if MCA_IO is None:
            self.MCA_IO = bridgeport_mca.mca_portal.MCA_PORTAL(cmd_root, ctrl_root, mds_ip)  # For communication with the MDS
            print(MCA_IO)
        else:
            self.MCA_IO = MCA_IO
