...
def template_distance(template, histo, xrange, yrange, xspan=0):
    """
        Compute the distnce betwen a histogram and a template as the sum 
        ...
        if xspan>=0 it defines a +/-xspan for searching for the next neighbour
        ...
        keV/bin gain for a meaning fule comparison.
