...
class arm_status:
    ...
    def registers_2_fields(self):
        ...
        self.fields = {
            ...
            'dg_target': self.registers[3],  # Not used
            ...
            'trigger_level': self.registers[36] # DC-trigger level
        }
...
class arm_ctrl:
    ...
    def fields_2_user(self):
        self.user = {
            ...
            'coincidence': (int(self.fields['run_mode']) >> 11) & 0x1,  # Turn on coincidence histogramming
    ...
    def user_2_fields(self):
        ...
        self.fields['run_mode'] = \
            ...
            (int(self.user['coincidence']) & 0x1)*0x800 
...
class arm_histo_2k(arm_histogram):
    def __init__(self):       
        super().__init__()
        self.registers = [0] * 1872
