...
class fpga_ctrl:
    ...
    def registers_2_fields(self):
        ...
        self.fields['psd_reject'] = (val >> 11) & 1  
        self.fields['cr15_upper'] = (val >> 12) & 0xF 
    ...
    def fields_2_registers(self):
        ...
        self.registers[15] = (int(self.fields['ha_mode']) & 1) + (int(self.fields['trace_mode']) & 1) * 0x2 + \
                             ...
                             (int(self.fields['psd_reject']) & 1) * 0x800 + (int(self.fields['cr15_upper']) & 0xF) * 0x1000
...
class arm_ctrl:
    ...
    def registers_2_fields(self):
        ...
        self.fields = {
            ...
            'run_mode': int(self.registers[13]),  # Reserved
            'run_action': int(self.registers[14]),  # One time actions; self-clearing
            'boot_wait': int(self.registers[28])
        }
    ...
    def fields_2_registers(self):
        ...
        self.registers[28] = self.fields['boot_wait']
...
class fpga_tgf_lm:
    ...
    def registers_2_fields(self):
        ...
        self.fields = {
            #'reg_0': reg0,
            'num_events': self.registers[0] & 0x7FF,
            #'bank': (self.registers[0] >> 16) & 1,
            'energies': self.registers[7:E0:6],
            #'psd': self.registers[6:E0:6],
            ...
            #'peak': [(p0 & 0xFF00)//0x100 + (p1 & 0xF)*0x100 for p1, p0 in zip(self.registers[11:E0:6], self.registers[10:E0:6])] ,
            'peak': [(p & 0xFFF0)//0x10  for p in self.registers[10:E0:6]] ,
        ...
        #'flags': [(x & 0xFF00)//0x100 for x in self.registers[11:E0:6]],
