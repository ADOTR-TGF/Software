...
def read_arm_status(file_name):
    """
    We assume that only one device is attached, and that the Morpho Data Server is running.
...
read_arm_status(file_name="./data/arm_status.json")
